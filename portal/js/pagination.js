; (function (window) {
	...
	Pagination.prototype.renderPageNumber = function () {
		...
		data.forEach(function (number) {
			console.log('kkkkkk ',current,number);
		...
		//首页鼠标移动到预约门店、VR探店
		 $('.test_appoinment .content1 a div').on({
			 mouseover:function(){
				 ...
				 console.log('FFFFF ',bottomLength,leftLength);
	...
	$(function(){
		$('.test_appoinment .content1').on({
			mouseover:function(){
				console.log('AAAA ',$('.test_appoinment .content1').width(),$('.test_appoinment .content1').height());
